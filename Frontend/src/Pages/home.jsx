    ...
    return (
        <div className="bg-gray-50 min-h-screen relative overflow-x-hidden">
            ...
            <div className="pt-[80px]">
                ...
                {/* HERO */}
                <section id="home" className="relative text-center pt-24 sm:pt-28 md:pt-32 pb-16 px-4 sm:px-6 md:px-8 overflow-hidden">
                ...
                {/* HOW IT WORKS */}
                <section id="how-to-use" className="py-20 px-6 md:px-20 bg-purple-50">
